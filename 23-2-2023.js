...
function cssChange (id,currentActiveEle,getCssProp,row_count,section){
    let txtInput = document.getElementById(id);
    let currentEle = txtInput.id.startsWith('cta_') ? document.getElementById(currentActiveEle).querySelector('.cta') : document.getElementById(currentActiveEle);
...
function get_mHead_id(clicked_id_txt){
    ...
    function updatecssValue (id, getCssProp){
        ...
        mob_View.addEventListener("click", function() {toggleView('mobView', txtInput, currentActiveEle_txt, getCssProp,'text')});
        let desk_view = document.getElementById("deskView")
        desk_view.addEventListener("click", function() {toggleView('deskView', txtInput, currentActiveEle_txt, getCssProp,'text')});
...
function get_cta_id(clicked_id_cta) {
    ...
    function updateCtaCssValue (id, getCssProp){
        ...
        txtInput.addEventListener('input', (e) => {
            if(e.currentTarget.id == "cta_Size") cssChange('cta_Size',currentActiveEle_cta, getCssProp, 'total_cta_Row','cta');
